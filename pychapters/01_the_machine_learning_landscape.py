...
import os
import sys
os.chdir(r"C:\Users\RobertL\Source\Repos\ML\handson-ml\pychapters")
...
# Load the data
# First check that the data file exists
oecdFileExists = os.path.exists(datapath)
if oecdFileExists == False:
